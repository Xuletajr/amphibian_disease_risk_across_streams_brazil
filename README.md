...
## Code
__*bd_occupancy_prevalence_Brazil_Atlantic_Forest.R*__ - R code to import, reshape, and run hierarchical Bayesian model (Miller et al. 2012, DiRenzo et al. 2018) to estimate *Bd* occurrence, prevalence, and infection intensity (via JAGS through R).
